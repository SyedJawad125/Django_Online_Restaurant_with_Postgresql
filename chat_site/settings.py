"""
Django settings for chat_site project.
...
SECRET_KEY = 'django-insecure-x6l=-_v0=6c#+-zd!psi1p!jl5+tewa)&)4(gz-ciob(ns2h9)'
...
WSGI_APPLICATION = 'chat_site.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Django_Online_Restaurant_with_Postgresql',
        'USER':'mydb',
        'PASSWORD':'admin',
    }
}
